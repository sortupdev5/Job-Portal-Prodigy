      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                <div className="lg:col-span-7">
                  <h2 className="font-bold text-4xl md:text-5xl bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent mb-4">
                    Join the Medical Recruiter Community
                  </h2>
            ...
            <motion.div variants={itemVariants}>
              <div className="mb-6">
                <div className="flex items-center">
                  <img src={logoIcon} alt="Medical Recruiter" className="w-10 h-10 rounded-lg mr-3" />
                  <h3 className="text-2xl font-bold text-white">Medical Recruiter</h3>
                </div>
        ...
        >
          <div className="flex space-x-4">
            <a href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center group hover:bg-blue-600 transition-all duration-300">
        ...
        >
          <div className="flex items-center mb-4 md:mb-0">
            <img src={logoIcon} alt="Medical Recruiter" className="mr-3 w-8 h-8 rounded-lg" />
            <span className="bg-gradient-to-r from-teal-400 to-sky-400 bg-clip-text text-transparent font-bold text-xl">Medical Recruiter</span>
          </div>
          
          <div className="text-sm text-gray-500">
            © 2025 Medical Recruiter. All rights reserved.
          </div>
